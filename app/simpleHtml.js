  ...
  <div class="wrap">
    <div class="htop">
      <div>
        ...
        <p class="asof">📅 데이터 기준: 불러오는 중… · 매일 자동 갱신</p>
      </div>
...
<div class="wrap">
  ...
  <div class="acctgrid">
    <div class="acard">
      <h4>🪙 연금저축펀드</h4>
      <div class="b">연 최대 600만원까지 넣으면, <b>넣은 돈의 13.2~16.5%</b>를 <b>다음 해 연말정산에서 돌려받아요</b>(세액공제). 넣은 금액 기준이라 노후 적립의 1순위. ETF 매매·배당 세금도 <b>인출 때까지 미뤄져요</b>.</div>
  ...
  <div class="bignote" style="margin-top:14px">
    🧭 <b>왜 이 순서일까? (연금저축 → IRP → ISA)</b><br>
    <b>① 연금저축펀드 먼저</b> — 그 해 <b>계좌에 넣은 돈의 13.2~16.5%</b>를 <b>다음 해 연말정산에서 돌려받고</b>(세액공제 · 주식을 사든 안 사든 넣은 돈 기준), 주식형을 <b>100% 담을 수 있어</b> 가장 자유로워요. 가성비 1등이라 1순위.<br>
    <b>② IRP 다음</b> — 똑같이 세액공제(한도를 <b>600만→900만</b>으로 늘림). 단 주식형은 <b>70%까지만</b> 담기니, 연금저축을 다 채운 뒤에 확장.<br>
    <b>③ ISA 마지막</b> — 세액공제는 <b>없지만</b>(그래서 후순위) <b>55세 전에도 쓸 수 있어</b> 유연해요. 여윳돈·비상금 성격은 여기로.<br>
    👉 <b>핵심 원리</b>: "<b>공짜 돈(세액공제)부터 최대한 챙기고, 그다음 자유로운 그릇</b>" 순서예요. 노후 목적이라 <b>55세 잠금</b>도 문제가 안 돼요.<br>
    ⚠️ 미국에 직접 상장된 VOO·SCHD는 연금계좌에서 못 사니, 연금계좌에선 <b>국내상장(TIGER·ACE·SOL 등)</b> S&amp;P500·배당 ETF를 사세요.
  </div>
